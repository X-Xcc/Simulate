      ...
      >
        <header className="text-center flex flex-col items-center">
          <div className="flex items-center gap-sm mb-sm text-primary-fixed-dim">
            ...
            <h1 className="text-heading font-extrabold tracking-wider">长明灯</h1>
          </div>
          <p className="text-body-lg font-bold text-on-primary-container/80 tracking-wide font-sans">监狱智能行为分析系统</p>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-lg mt-md">
          ...
          <div className="space-y-md">
            <div className="flex flex-col gap-xs">
              <label className="text-caption font-bold text-on-primary-container/60 uppercase tracking-widest pl-1">账号</label>
            ...
            <div className="flex flex-col gap-xs">
              <label className="text-caption font-bold text-on-primary-container/60 uppercase tracking-widest pl-1">密码</label>
              <div className="relative group">
                <div className="absolute left-md top-1/2 -translate-y-1/2 text-outline group-focus-within:text-primary transition-colors">
                  <Lock size={18} />
                </div>
          ...
          <div className="flex gap-sm">
            <button
              ...
              className="flex-1 h-[36px] bg-white/5 border border-outline-variant/20 rounded-lg text-body-sm font-bold text-on-primary-container/60 hover:bg-white/10 hover:text-primary transition-all"
            >
              超级管理员 (xx/123)
            </button>
            <button
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full h-[52px] bg-primary hover:bg-primary-container text-on-primary rounded-lg font-bold text-body tracking-[2px] shadow-[0_4px_16px_rgba(0,81,174,0.3)] hover:shadow-[0_6px_20px_rgba(0,81,174,0.5)] transition-all flex items-center justify-center gap-sm disabled:opacity-50 group border border-primary-fixed/20 relative overflow-hidden"
          >
          ...
          <p className="text-caption text-center text-outline/40 px-lg leading-relaxed">
            仅限授权人员登录。系统将自动记录所有操作行为，任何违规尝试将触发安防联动报警。
          </p>
        </form>

        <footer className="mt-xs text-center border-t border-outline-variant/10 pt-md">
          <p className="text-body-sm font-mono text-outline/50 flex items-center justify-center gap-xs">
